        ...
        <div v-if="submitted" class="q-mt-xl">
          ...
          <q-card flat class="q-pa-lg ns-terminal-preview bg-black">
            <div class="text-mono text-caption q-gutter-y-xs">
              <div class="text-positive">[SUCCESS] API request accepted</div>
              ...
              <div class="text-white">module_processing: {{ searchStore.selectedModule }}...</div>
              <div class="text-blue animate-pulse q-mt-md">Processing locally in the API service...</div>
            </div>
            <q-btn 
              flat 
              dense 
...
const startInvestigation = async () => {
  try {
    ...
    $q.notify({
      message: 'API accepted the investigation request',
      color: 'primary',
      position: 'top',
      icon: 'radar'
    })
